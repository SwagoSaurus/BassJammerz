...
public class HighscoreTableFunkyFunScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        jsonString = PlayerPrefs.GetString("highscoreFunkyFunTable");
    ...
    private void AddHighscoreEntry(float Score, string Name)
    {
        ...
        PlayerPrefs.SetString("highscoreFunkyFunTable", json);
        PlayerPrefs.Save();
    }
